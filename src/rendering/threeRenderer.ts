  ...
  private syncVehicles(
    ...
    for (let index = 0; index < count; index += 1) {
      ...
      this.setAgentMatrix(
        ...
        index,
        vehicle.x,
        RENDER_HEIGHTS.roadSurface + 0.36 * scale[1],
        vehicle.z,
        vehicle.heading,
        scale,
      );
      ...
      this.setAgentMatrix(
        ...
        RENDER_HEIGHTS.roadSurface + 1.06 * scale[1],
  ...
  private syncPedestrians(
    ...
    for (let index = 0; index < count; index += 1) {
      ...
      this.setAgentMatrix(
        ...
        index,
        pedestrian.x,
        RENDER_HEIGHTS.sidewalkSurface + 0.64 * heightScale,
        pedestrian.z,
        pedestrian.heading,
        scale,
      );
      this.setAgentMatrix(
        ...
        index,
        pedestrian.x,
        RENDER_HEIGHTS.sidewalkSurface + 1.53 * heightScale,
        pedestrian.z,
        pedestrian.heading,
        scale,
      );
