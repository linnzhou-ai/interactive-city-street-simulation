...
describe("parseProjectSnapshot", () => {
  ...
  it("migrates broad legacy building categories to economic functions", () => {
    const parsed = parseProjectSnapshot(JSON.stringify({
      version: PROJECT_STATE_VERSION,
      savedAt: "2026-07-28T00:00:00.000Z",
      ...EMPTY_EDITOR,
      buildings: [{
    ...
    expect(parsed.buildings[0].function).toBe("retail");
  });
