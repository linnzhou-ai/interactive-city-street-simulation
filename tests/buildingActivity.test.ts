...
describe("building activity", () => {
  ...
  it("combines placed buildings into live travel demand", () => {
    ...
    expect(summary.vehicleDemandBoost).toBeGreaterThan(0);
    expect(summary.pedestrianDemandBoost).toBeGreaterThan(0);
  });
});
